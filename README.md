...
<img src="bots-range.jpg" width="380" alt="Bots at range">
...
<img src="vehicles.jpg" width="520" alt="Vehicles">
...
<img src="loot.jpg" width="520" alt="Loot">
...
- Hit markers, driven by the damage you have actually dealt
...
<img src="players.png" width="520" alt="The players page">
...
<img src="aim.png" width="520" alt="The aim page">
...
Three shapes, its own colour, and an option that draws a bigger mark for a
round that did more damage. It is driven by the damage figure the game keeps
for you, so a mark appears for a hit you could not see land.
...
**2 September** - Drivers and passengers are drawn like anybody else, so a car
with four men in it reads as four men.

**1 September** - kmbox net supported alongside the MAKCU, over the network,
with its own address, port and MAC.
